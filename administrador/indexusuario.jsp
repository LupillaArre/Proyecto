...
<script LANGUAGE="JavaScript">
		...
		{
		var agree=confirm("Está seguro de modificar este registro? Este proceso es irreversible.");
		if (agree)
		  return true ;
		else
		   return false ;
				...
				<nav class="navbar" role="navigation">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav top-nav-info">
							...
							<li><a href="../Cliente/indexcliente.jsp" class="active">Clientes</a></li>
							<li><a href="indexusuario.jsp">Usuarios</a></li>
							<li><a href="../Categoria/indexcat.jsp">Categoría</a></li>
							<li><a href="../Subcategoria/indexsub.jsp">Subcategoría</a></li>
							<li><a href="../Clasificacion/indexcla.jsp">Clasificación</a></li>
